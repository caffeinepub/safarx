  ...
  useSEO(
    destination
      ...
      : {
          ...
          description:
            "The destination you are looking for could not be found. Browse all Indian destinations on SafarX and plan your perfect trip.",
        },
  );
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-saffron-50 border border-saffron-200 rounded-2xl p-6">
              ...
              <p className="font-body text-sm text-terracotta-700 mb-4">
                Let our travel experts craft a personalised itinerary for your
                perfect trip.
              </p>
