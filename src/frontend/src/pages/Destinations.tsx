...
import { type Region, destinations } from "@/data/destinations";
...
const regionDescriptions: Record<Region, string> = {
  ...
  North:
    "Majestic Himalayas, royal Rajasthan, spiritual Gangetic plains, and hidden Himalayan valleys.",
  South:
    "Tropical backwaters, ancient temples, pristine beaches, lush forests, and secret coastal towns.",
  ...
  Northeast:
    "Misty hills, living root bridges, tribal cultures, wildlife wonders, and alpine valleys.",
};
...
export default function Destinations() {
  ...
  useSEO({
    ...
    twitterDescription:
      "Browse 30+ handpicked destinations across India — Himalayan peaks, Rajasthan forts, Kerala backwaters, Andaman beaches, hidden gems, and Northeast tribal trails, all on SafarX.",
    twitterImage:
      "/assets/generated/hilly-destinations-banner.dim_1400x600.png",
  });
  ...
  const regularDestinations = filtered.filter(
    (d) => !d.tags?.includes("Hidden Gem"),
  );
              ...
              {hiddenGems.length > 0 && (
                <div>
                  ...
                  <p className="font-body text-sm text-muted-foreground text-center mb-6">
                    Discover India's lesser-known treasures — destinations that
                    reward the curious traveler with authentic experiences and
                    fewer crowds.
                  </p>
