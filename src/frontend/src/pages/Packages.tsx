  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(/assets/generated/packages-hero-banner.dim_1400x500.png)",
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="font-cormorant italic text-xl text-ivory-200 max-w-xl mx-auto">
            Thoughtfully crafted journeys across India — from Himalayan peaks to
            tropical shores, every package is a story waiting to unfold.
          </p>
        </div>
      </div>
      ...
      <section className="py-16 bg-terracotta-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center text-ivory-100">
          ...
          <Link to="/contact" search={{}}>
            <Button
              variant="outline"
              className="border-ivory-300 text-ivory-100 hover:bg-white/10 font-body font-semibold rounded-full px-8"
            >
              Contact Us
            </Button>
          </Link>
