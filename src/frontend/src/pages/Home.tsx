...
import { ArrowRight, Award, MapPin, Star, Users } from "lucide-react";
...
const whyChooseUs = [
  {
    ...
    description:
      "Our handpicked local guides bring destinations to life with authentic stories and hidden gems.",
  },
  {
    emoji: "✈️",
    title: "Curated Itineraries",
    description:
      "Every journey is thoughtfully crafted to balance iconic landmarks with off-the-beaten-path experiences.",
  },
  {
    emoji: "🏨",
    title: "Handpicked Stays",
    description:
      "From heritage havelis to eco-lodges, we select accommodations that enhance your travel story.",
  },
  {
    emoji: "🤝",
    title: "24/7 Support",
    description:
      "Our dedicated team is always available to ensure your journey is seamless and memorable.",
  },
];
  ...
  return (
    <main>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="font-body text-muted-foreground max-w-xl mx-auto text-base leading-relaxed">
              From ancient temples to pristine beaches, explore India's most
              captivating destinations curated by our travel experts.
            </p>
          </div>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url(/assets/generated/dest-rajasthan.dim_800x600.png)",
