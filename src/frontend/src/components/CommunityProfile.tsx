    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-terracotta-100 overflow-hidden shadow-sm">
        ...
        {profile?.bio && (
          <div className="px-6 py-3 border-b border-terracotta-50">
            <p className="font-body text-terracotta-600 text-sm italic">
              "{profile.bio}"
            </p>
          </div>
        )}
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-display text-lg font-bold text-terracotta-800">
            My Stories
          </h3>
        </div>
        ...
        {postsLoading && (
          <div className="space-y-3">
            {[1, 2].map((i) => (
              <div
                key={i}
                className="bg-white rounded-xl border border-terracotta-100 p-4 space-y-2"
              >
        ...
        {!postsLoading && (!posts || posts.length === 0) && (
          <div className="text-center py-12 bg-white rounded-2xl border border-terracotta-100">
            ...
            <p className="font-display text-lg font-bold text-terracotta-700 mb-1">
              No stories yet
            </p>
