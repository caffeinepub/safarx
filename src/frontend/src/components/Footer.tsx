...
import { Compass, Heart, Mail, MapPin, Phone } from "lucide-react";
import {
  SiFacebook,
  SiInstagram,
  SiLinkedin,
...
export default function Footer() {
  ...
  const appId = encodeURIComponent(
    typeof window !== "undefined" ? window.location.hostname : "safarx-in",
  );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="font-body text-sm text-ivory-300 leading-relaxed mb-5">
              Your trusted companion for exploring the incredible diversity of
              India — from the Himalayas to the backwaters, deserts to
              rainforests.
            </p>
